...
# Check if the downloaded DataFrame is empty
if df.empty:
    st.error(f"No data found for stock symbol '{stock}' in the specified date range. Please check the symbol and try again.")
    st.stop()
